              ...
              <Popover.Content style={{ width: "280px" }}>
                <Flex direction="column" gap="3">
                  ...
                  <Button
                    ...
                    variant="soft"
                    onClick={() =>
                      setShowContrastInsights(!showContrastInsights)
                    }
                    style={{ width: "100%" }}
                  >
          ...
          {showContrastInsights && (
            ...
            >
              ...
              <Text size="1" color="gray" style={{ lineHeight: "1.6" }}>
                This contrast analysis examines all possible
                foreground/background combinations within your scale. The
                statistics show how many color pairs meet accessibility
                standards.
              </Text>
            </Box>
          )}
